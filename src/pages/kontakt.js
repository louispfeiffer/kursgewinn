        ...
        <section class="bg-white dark:bg-gray-900">
          <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            ...
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">
              Haben Sie Fragen oder möchten Sie mehr über unsere Services erfahren? Kein Problem! Schreiben Sie uns hier einfach eine kurze Nachricht, und wir versuchen, Ihnen so schnell wie möglich weiterzuhelfen.
            </p>
          </div>
        </section>
