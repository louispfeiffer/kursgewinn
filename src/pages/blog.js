            ...
            <body>
                ...
                <section class="bg-white dark:bg-gray-900">
                    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Haben Sie eine Frage, hier gibt es die Antwort</h1>
                        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Schauen Sie sich alle aktuellen Blogbeiträge an, um immer auf dem neuesten Stand zu sein. Wenn es noch unbeantwortete Fragen gibt, können Sie uns auch gerne kontaktieren.</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 w-3/4 gap-8">
                        ...
                        <div class="relative w-full">
                            ...
                            <div class="absolute top-0 left-0 w-full h-full bg-black hover:bg-opacity-0 bg-opacity-20 rounded-lg flex items-center justify-center">
                                <div class="text-white text-xl font-black px-4 py-2 text-center drop-shadow-xl">
                        ...
                        <div class="relative w-full">
                            ...
                            <div class="absolute top-0 left-0 w-full h-full bg-black hover:bg-opacity-0 bg-opacity-20 rounded-lg flex items-center justify-center">
                                <div class="text-white text-xl font-black px-4 py-2 text-center hover:drop-shadow-2xl">
                                    Kurzer Call to Action für den Blog das ist ein dropshadow test
                                </div>
                            </div>
                        </div>
